...
function CustomerDetails(): JSX.Element {
  ...
  function errorVisiblePhone() {
    console.log('Hrere is phone error', datavalid, datavalid.validphone);
  ...
  function handlePhone() {
    ...
    let number = Number(details.phoneNumber.current)
    let phoneNumberLength = details.phoneNumber.current.length;
    console.log('here is number length', phoneNumberLength,);
...
<View style={{backgroundColor:'#E6E6E6' ,width:40}}><Icon name='envelope-o' size={33} style={styles.icon} color='#5a5a5a'/></View>
      ...
      <View style={styles.box}>
<View style={{backgroundColor:'#E6E6E6' ,width:40,}}><Icon name='phone' size={35} style={styles.icon} color='#5a5a5a'/></View>
      <InputText
